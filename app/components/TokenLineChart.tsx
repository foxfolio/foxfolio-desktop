...
const mapActionsToProps = (dispatch: Dispatch<GlobalState>) => bindActionCreators(TickerActions, dispatch);

export const TokenLineChart = connect<StateProps, DispatchProps, OwnProps, GlobalState>(mapStateToProps, mapActionsToProps)(ThemedTokenLineChart);
